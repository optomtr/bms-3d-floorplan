...
import { mat, box, cyl, tint, defineModel, legs4Box, WOOD, METAL, WHITE, GLASS, type FurnitureBuilder } from '../primitives';

export const decorModels = {
  mirror: defineModel((g, c) => {
    g.add(tint(box(0.6, 0.9, 0.04, mat(METAL), 0, 0, 0), c));
    g.add(box(0.5, 0.8, 0.01, mat(0xaad4e0, { metalness: 0.9, roughness: 0.1 }), 0, 0, 0.03));
  }),
  plant: defineModel((g, c) => {
