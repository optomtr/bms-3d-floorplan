...
import { mat, box, tint, defineModel, legs4Box, legs4Cyl, WOOD, FABRIC, METAL, WHITE, DARK, type FurnitureBuilder } from '../primitives';
...
export const bedroomModels = {
  bed: defineModel((g, c) => {
    ...
    legs4Box(g, 0.1, 0.1, 0.1, foot, 0.82, 0.92, 0.05);
  ...
  nightstand: defineModel((g, c) => {
    ...
    legs4Cyl(g, 0.02, 0.03, 0.12, dark, 0.2, 0.16, 0.06, 8);
