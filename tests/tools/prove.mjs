...
const CASES = [
  ...
  // Потеря контекста WebGL: без обработчика планшет после сна остаётся с
  // чёрным прямоугольником — ровно то, на что жаловался владелец.
  ['31-webgl-context-lost', '', 'break-no-gl-recovery', 'red'],
